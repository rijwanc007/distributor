    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-8">
                <a class="btn btn-primary btn-lg btn-block" href="{{route('sale.create')}}"><i class="fa fa-plus" aria-hidden="true"></i> Add Sale</a>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4 text-center">
                <div class="search_margin">
                    {!! Form::open(['route' => 'exist.sale.search','method' => 'POST']) !!}
